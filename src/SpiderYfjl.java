...
public class SpiderYfjl {
    public static void main(String args[]) throws InterruptedException, IOException, ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
        ...
        int a=1;
        String[] zhanghao=new String[]{"809331777@qq.com","wikw107@163.com","1289121695@qq.com","123@163.com","lijing1317704@163.com","382391215@qq.com","18518692887"};
        String[] mima=new String[]{"123456","123456","123456","123456","19920725","zhj123","123456"};
        int flag=0;
        for(int i=4519747;i>4500019;i++) {
