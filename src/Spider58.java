...
public class Spider58 {
    public static void main(String args[]) throws InterruptedException, IOException, ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
        ...
        String url="jdbc:mysql://123.59.74.132:3306/game_db_qa?useUnicode=true&amp;charsetEncoding=utf8&useCursorFetch=true&defaultFetchSize=100?useUnicode=true&characterEncoding=utf-8";
        ...
        driver.findElement(By.id("email")).sendKeys("1343490516@qq.com");
        ...
        while(dl!=null) {
            ...
            driver.findElement(By.id("email")).sendKeys("1343490516@qq.com");                      //写入用户名
            driver.findElement(By.id("pwd")).clear();
            driver.findElement(By.id("pwd")).sendKeys("123456789");
            Thread.sleep(2000);
            driver.findElement(By.className("sign-btn")).click();
        ...
        Thread.sleep(2000);
        driver.get("http://www.yifengjianli.com/userset/superPool58");
        Thread.sleep(2000);
        driver.findElement(By.className("yf-btn-blue2")).click();
        int a=1;
        int accountflag=0;
        int dianji=10;
        String zhanghu[]=new String[]{"642213614@qq.com","17853255412"};
        String mima[]=new String[]{"KUIbu210","superhero"};
        for(int i=1;i<=50;i++) {
            Thread.sleep(10000);
            ...
            Elements links = doc.select("td[style=max-width:260px;padding-left:28px!important]>a[ng-style={'color': item.isRead=='1'||item.isDownLoad=='1'?'rgb(129, 42, 208)':''}]");
            ...
            for (Element link : links) {
                ...
                try {
                    String hun = null;
                    String zhi = null;
                    String childLink = "http://www.yifengjianli.com" + link.attr("href");
